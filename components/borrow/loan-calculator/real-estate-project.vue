...
<template>
    ...
    <div class="property-estimated-value mb-6">
        <h2>Property Estimated Value</h2>
    ...
    <div class="estimated-ltv mb-6">
        <div>
            <h2>Estimated LTV</h2>
            <span class="value">19.5 %</span>
        </div>
        <div>
            <h2>Indicative Interest Rate</h2>
    ...
    <div class="frequency">
        ...
        <div class="btn-group gap-3">
            <div class="btn-group gap-3">
                ...
                <Button :class="loanFrequency == 'annual' && `active`"
                    @click="onLoanFrequencyChange('annual')">Annual</Button>
            </div>
        </div>
    </div>
